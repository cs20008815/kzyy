...
import org.clj.crmproj.util.CollectionUtility;
...
public class StringUtility {
    ...
    /**
     * 原字符串首字母大写并在其首部添加指定字符�? 例如：str=name, preString=get -> return getName
     *
     * @param str 被处理的字符�?
     ...
     * @param str 字符�?
     * @param prefix 前缀
     * @return 切掉后的字符串，若前�?不是 preffix�? 返回原字符串
     */
    ...
    /**
     * 改进JDK subString<br>
     * index�?0�?始计算，�?后一个字符为-1<br>
     * 如果from和to位置�?样，返回 "" example: abcdefgh 2 3 -> c abcdefgh 2 -3 -> cde
     *
     * @param string String
     * @param fromIndex �?始的index（包括）
     ...
     *
     * @param camelCaseStr 转换前的驼峰式命名的字符�?
    ...
    /**
     * 补充字符串以满足�?小长�? StrUtil.padPre("1", 3, '0');//"001"
     *
     * @param str 字符�?
     * @param minLength �?小长�?
     * @param padChar 补充的字�?
    ...
    /**
     * 补充字符串以满足�?小长�? StrUtil.padEnd("1", 3, '0');//"100"
     *
     * @param str 字符�?
     * @param minLength �?小长�?
     * @param padChar 补充的字�?
    ...
    /**
     * 数字型String字符串转换成int型数�?
     * @param str string类型的数�?
     * @return
     */
    ...
    public static String AssembFilePath(String... params){
        StringBuffer sb = new StringBuffer();
        for (int i=0; i<params.length;i++){
            String p = params[i].replace("\\","/");
            if(i == params.length-1){
                sb.append(p.endsWith("/")?p.substring(0,p.length()-1):p);
            }else{
                sb.append(p.endsWith("/")?p:p+"/");
            }
    ...
    public static void main(String[] args) {
        String p1 = "D:\\safe\\code/safety/safety-webapp/src/main/webapp/upload/";
        String p2 = "2\\";
        String p3 = "3\\";
        System.out.println(AssembFilePath(p1, p2, p3));
    }
